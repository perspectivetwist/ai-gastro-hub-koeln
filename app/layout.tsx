...
export const metadata: Metadata = {
  ...
  title: "AI-Readiness für die Kölner Gastronomie | AI Shift Drift",
  description:
    "4 kostenlose KI-Scanner für Gastronomiebetriebe in Köln. Sichtbarkeit, Reputation, Agent-Readiness und Sicherheit, kostenlos prüfen.",
  robots: { index: true, follow: true },
  alternates: {
    canonical: "https://www.ki-gastronomie.com/staedte/koeln",
  },  openGraph: {
    title: "AI-Readiness für die Kölner Gastronomie | AI Shift Drift",
    description:
      "4 kostenlose KI-Scanner für Gastronomiebetriebe in Köln. Sichtbarkeit, Reputation, Agent-Readiness und Sicherheit, kostenlos prüfen.",
    locale: "de_DE",
    url: "https://www.ki-gastronomie.com/staedte/koeln",
  },
};
